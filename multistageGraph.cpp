...
const int MAX_VERTICES = 6; // Maximum number of vertices
const int INF = 999999;  // Infinity value
...
int main() {
    // Simplified example multistage graph represented as an adjacency matrix
